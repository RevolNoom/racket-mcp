...
- ✅ `mcp/transport/test/portability-test.rkt` — S3 restricted-load portability sweep (item 022)
...
- [x] Load test: still no subprocess/socket module pulled in
- [x] Parity rows `transport.ts`, `inMemory.ts` marked `partial`
